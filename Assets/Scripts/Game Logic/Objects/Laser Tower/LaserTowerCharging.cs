...
public class LaserTowerCharging : MonoBehaviour
{
    ...
    /// <summary>
    /// ѕроверить, полностью ли зар€жена лазерна€ башн€ в данный момент
    /// </summary>
    ...
    /// <summary>
    /// ѕроверить, полностью ли разр€жена лазерна€ башн€ в данный момент
    /// </summary>
    ...
    /// <summary>
    /// ѕроиграть звук зар€дки/разр€дки лазерной башни
    /// </summary>
