...
public static class GameProperties
{
    ...
    /// <summary>
    /// Общее количество сгенерированных этажей на лестнице (На самом нижнем находится финальная комната)
    /// Значение каждую игру генерируется случайно в заданном дипазоне
    /// </summary>
