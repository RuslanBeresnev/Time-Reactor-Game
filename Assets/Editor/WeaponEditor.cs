...
///Перед началом изменений параметров оружия требуется распаковать префаб:
/// 1) выбираем объект с компонентом Weapon
/// 2) Правая кнопка мыши -> Prefab -> Unpack Completely

///Если требуется добавить в игру оружие, находящееся вне арсенала игрока,
///важно не забыть активировать Box Collider у главного объекта этого оружия с компонентом Weapon
